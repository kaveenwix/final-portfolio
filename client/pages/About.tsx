      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-black text-white rounded-3xl p-8">
            <h2 className="text-2xl font-archivo font-bold mb-6">who i am!</h2>
            <p className="font-helvetica font-bold leading-relaxed">
              Hi there! im Kaveen and im a lover off all things media, movies,
              music. these are the things that inspire me and the work produce.
              When im not in school or work im looking for the next best spot to
              eat, thrifting, playing basketball and hanging out with my closest
              friends.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-black text-white rounded-3xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-archivo font-bold">Development</h3>
              </div>
              <ul className="font-archivo font-bold space-y-2">
                <li>HTML</li>
                <li>CSS</li>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-black text-white rounded-3xl p-8">
              ...
              <p className="font-helvetica font-bold leading-relaxed">
                When working on something asking input from friends, family, and
                coworkers is what i think is the best thing you can do because
                no one else is gonna keep it %100 with you and that should
                inspire you to get better
              </p>
            </div>
          </div>
        </div>
